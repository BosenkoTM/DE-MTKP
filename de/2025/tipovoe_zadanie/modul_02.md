...
| 3-местный бюджет                        | 14.02.2025 | 02.03.2025  | 62,000  | 62,000   | 62,000         | 16               |
...
- **Эконом двухместный с 2 раздельными кроватями**:
  ...
  - Чистая выручка за 15.02.2025: $ \frac{94,500}{33} = 2,864 $ руб.

Таким образом:
- Чистая выручка: 2,864 руб.
- Количество проданных номеров: 1

$$
ADR_{15.02.2025} = \frac{2,864}{1} = 2,864 \, \text{руб.}
$$
